...
file <- file.path("neweststanfromanna.stan")
...
recov_df %>% ggplot(aes(trueWeight, inferredWeight)) +
...
```{r}
ggplot(df, aes(x = trueWeight,
                       y = inferredWeight)) + #Setting aesthetics for plot
